...
def upgrade() -> None:
    op.create_table(
        ...
        ,Column('CAFE_NM',String(30), nullable=False) #추진위원회/조합명
        ...
        ,Column('ZONE_NM',String(30), nullable=False) #정비구역명칭
        ,Column('ZONE_ADRES',String(30), nullable=False) #정비구역위치
        ,Column('ZONE_AR',Float, nullable=False) #정비구역면적
        ,Column('TOTAR',Float, nullable=False) # 건축연면적
        ,Column('CTY_PLAN_SPFC_NM',String(50), nullable=False) # 용도지역
        ,Column('CTY_PLAN_SPCFC_NM',String(30), nullable=False) #용도지구
        ,Column('LAD_BLDLND_AR',Float, nullable=True) #택지면적
        ...
        ,Column('BILDNG_PRPOS_NM',String(30), nullable=False) #주용도
        ,Column('BILDNG_BDTLDR',Float, nullable=False) # 건폐율
        ,Column('BILDNG_FLRSPCER',Float, nullable=False) # 용적률
        ,Column('BILDNG_HG',Float, nullable=False) # 높이
        ...
        ,Column('BILDNG_RM',String(30), nullable=True) #건축계획비고
        ,Column('LOCIMG01',String(50), nullable=False) #위치도
        ,Column('LOCIMG02',String(50), nullable=False) #조감도
        ,Column('LOCIMG03',String(50), nullable=False) #배치도
