...
class Dump_construction_tbl():
    ...
    def get_data(self):
        ...
        return df_total
    def update_construction(self, df_total):
        ...
        for i, row in df_total.iterrows():
            construction = Construction(
                ...
                ,keywords = get_keywords(row['CAFE_NM'])
    ...
    def store_in_db(self):
        # tbl_dump = dump_construction_tbl.Dump_construction_tbl()
        df_total = self.get_data()
        construction_list = self.update_construction(df_total)
        for construction in construction_list:
            create_construction(construction)

if __name__ == '__main__':
    dump_tbl = Dump_construction_tbl()
    dump_tbl.store_in_db()
    print(dump_tbl.get_data())
